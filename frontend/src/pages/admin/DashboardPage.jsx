// src/pages/admin/DashboardPage.jsx — Mobile First
  ...
  return (
    <div>
      ...
      <div className="mb-6 sm:mb-8">
        <h1 className="font-display text-xl sm:text-3xl font-bold text-gray-900">
          สวัสดี, {admin?.display_name || admin?.username} 👋
        </h1>
        <p className="text-gray-400 text-sm mt-1">ภาพรวมระบบ NutriSite</p>
      </div>
        ...
        <>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
            {stats.map(s => (
              <div key={s.label}
                ...
                className={`${s.bg} rounded-2xl p-4 sm:p-5 ${s.link ? 'cursor-pointer hover:shadow-md active:scale-95 transition-all' : ''}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm p-4 sm:p-6">
              <h2 className="font-bold text-sm sm:text-lg text-gray-800 mb-4">📂 อาหารในแต่ละหมวดหมู่</h2>
            ...
            {/* Latest foods */}
            <div className="bg-white rounded-2xl shadow-sm p-4 sm:p-6">
              <h2 className="font-bold text-sm sm:text-lg text-gray-800 mb-4">🕒 รายการล่าสุด</h2>
